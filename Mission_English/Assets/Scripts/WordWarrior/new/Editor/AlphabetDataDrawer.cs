...
public class AlphabetDataDrawer : Editor
{
    ...
    {
        IntializeReordableList(ref AlphabetPlainList, "AlphabetPlain", "Alphabet Plain");
        IntializeReordableList(ref AlphabetNormalList, "AlphabetNormal", "Alphabet Normal");
        IntializeReordableList(ref AlphabetHighlightList, "AlphabetHighlighted", "Alphabet Highlighted");
        IntializeReordableList(ref AlphabetWrongList, "AlphabetWrong", "Alphabet Wrong");
    }
    ...
    private void IntializeReordableList(ref ReorderableList list, string propertyName, string listLabel)
    {
